...
COPY --from=MAVEN_BUILD /home/ws/config/categoryscraper-settings.xml /home/ws/config/categoryscraper-settings.xml
COPY --from=MAVEN_BUILD /home/ws/target/ws-tradera-cs.jar /home/ws/run.jar
